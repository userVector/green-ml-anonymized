...
```{r}
data_frame <- read.csv("C:/Users/Vit/Desktop/gl-paper/green-ml-anonymized/new_analysis/new_rq1_rq3/rq3-data-knn.csv")
...
ggplot(data_frame, aes(x = joules, y = exp)) +
  geom_boxplot() +
  theme_minimal() +
  labs(title = "Energy consumption in KNN experiments", x = "energy consumption in joules", y = "") # +
```
